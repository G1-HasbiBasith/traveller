package com.sigaritus.swu.travel.ui.views.settings.item;
...
public class CheckItemViewH extends FrameLayout {
	...
	private void readAttrs(Context context, AttributeSet attrs) {
		if (null != attrs) {
			...
			if (a.hasValue(R.styleable.SettingViewItem_sBackground)) {
				Drawable drawable = a.getDrawable(R.styleable.SettingViewItem_sBackground);
				if (null != drawable) {
			...
			if (a.hasValue(R.styleable.SettingViewItem_settingTitle)) {
				String title = a.getString(R.styleable.SettingViewItem_settingTitle);
