...
public class PicActivity extends AppCompatActivity implements ListImageDirPopupWindow.OnImageDirSelected {
    ...
    private void getImages() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                ContentResolver mContentResolver = PicActivity.this
                        .getContentResolver();
